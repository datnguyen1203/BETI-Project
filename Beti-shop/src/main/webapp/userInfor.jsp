<%-- 
    Document   : userInfor
    Created on : Oct 28, 2023, 8:57:16 PM
    Author     : Dell
--%>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-xl modal-fullscreen-xxl-down">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <form method="post" action="User" id="editUser" class="container p-3 bg-body-tertiary rounded-5">
                                                <div class="m-3">
                                                    ...
                                                    <input type="hidden" name="id" value="<%= u.getUserID()%>">
                                                    <input type="hidden" id="oldpasscheck"
