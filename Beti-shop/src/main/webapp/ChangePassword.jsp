    ...
    <body>
        <div class="container">
            <div class="row justify-content-around">
                <!--Form Login-->
                <form method="post" action="changepass" id="loginform" class="col-6 p-3 m-5 bg-body-tertiary rounded-5">
                    ...
                    <div class="m-3">
                        ...
                        <input id="email" type="text" name="oldpass" class="form-control" placeholder="Enter old password" value="${requestScope.oldpass}" required="">
                    </div>
                    <div class="m-3">
                        <label class="form-label fw-bold">New Password</label>
                        <input id="email" type="text" name="newpass" class="form-control" placeholder="Enter new password" value="${requestScope.newpass}" required="">
                    </div>
                    <div class="m-3">
                        <label class="form-label fw-bold">Confirm Password</label>
                        <input id="email" type="text" name="confirmpass" class="form-control" placeholder="Enter confirm password" value="${requestScope.confirmPass}" required="">
                    </div>
                    ...
                    <div class="text-center">
                        <button type="submit" 
                                class="btn btn-dark fw-bold rounded-5" name="btnLogin" value="login">Change Password</button>
