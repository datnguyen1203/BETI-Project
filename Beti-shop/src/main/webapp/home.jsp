<%-- Document : home.js Created on : Oct 16, 2023, 1:20:08 PM Author : Dell --%>
                ...
                <div class="row">
                    <div id="product" role="button" class="container m-5 col-sm-2 col-lg-2" data-bs-toggle="modal"
                        ...
                        <div class="card" style="width: 15rem;">
                            <img src="img/product/product1.jpg" class="card-img " alt="product1">
                            <div class="card-body">
        ...
        <div class="modal-dialog modal-fullscreen-lg-down modal-dialog-centered modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="container-fluid">
                        <div class="row">
                            <img class="col-md-4" id="detailproductimg" src="img/product/product1.jpg"
