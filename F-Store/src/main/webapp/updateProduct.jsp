<%-- 
    ...
    Created on : Oct 19, 2023, 10:09:14 AM
    Author     : LEGION
--%>
                    ...
                    <div class="modal-content">
                        <form action="manageProduct" method="post" enctype="multipart/form-data" >
                            ...
                            <div class="modal-body">		
                                <input value="update" name="type" type="text" class="form-control hidden" >
                                <div class="form-group">
                                    <label>ID</label>
                                    <input value="${data.productID}" name="id" type="text" class="form-control" readonly required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label>Img</label>
                                    <input value="${data.productImg}" type="text" class="form-control" readonly required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input value="${data.productQuantity}" name="quantity" type="number" class="form-control" required>
                                </div>
                                <div class="form-group">
